    ...
    <section className="section-padding">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-16">
          <span className="text-sm text-accent font-semibold tracking-wider uppercase mb-4 block">About</span>
        ...
        <div className="bg-card rounded-3xl border border-border p-8 md:p-12 mb-16 shadow-lg">
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
            ...
            <div>
              ...
              <p className="text-sm text-accent font-semibold mb-4">MBBS Student • Aspiring Doctor • Content Creator</p>
              ...
              <p className="text-muted-foreground leading-relaxed">
                When I'm not studying Pathology or making colorful notes, you'll find me reading, journaling, or dreaming about the kind of doctor I want to become.
              </p>
            </div>
          </div>
        </div>
